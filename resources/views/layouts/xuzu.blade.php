...
<div id="product-list" class="my-5">
    <div class="container">
        <h5 class="text-center text-headline">XUZU STORE</h5>
        ...
        <div class="row mb-5 g-4">
            ...
            <div class="col-md-4 col-lg-3">
                <div class="card h-100">
                    <div class="thumbnail">
                        <img src="{{ asset('images/post/product/xuzu/' . $item->gambar) }}" class="card-img-top" alt="{{ $item->gambar }}">
                    </div>
                    ...
                    <div class="card-footer px-3 pb-3 pt-0 d-flex">
                        <a href="{{ route('product_detail', ['product' => 'xuzu', 'id' => $item->id]) }}" class="btn btn-primary btn-primary__landing-page me-2">Detail</a>
