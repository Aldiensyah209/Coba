    ...
    <div class="row mb-5 g-4">
      ...
      <div class="col-md-4 col-lg-3">
        <div class="card h-100">
          <div class="thumbnail">
            <img src="{{ asset('images/post/product/aneka_slempang/' . $item->gambar_as) }}" class="card-img-top" alt="{{ $item->gambar_as }}">
          </div>
          <div class="card-body p-3">
            <h5 class="card-title">{{ $item->nama_as }}</h5>
            <p class="card-text">{{ Str::limit($item->deskripsi_as, 45) }}</p>
          </div>
