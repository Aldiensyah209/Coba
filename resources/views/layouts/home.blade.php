        ...
        <div class="row gy-4">
            <div class="col-md-4">
                <div class="card h-100">
                    ...
                    <div class="thumbnail">
                        <img src="{{ asset('images/post/product/xuzu/' . $xuzu[0]->gambar) }}" class="card-img-top" alt="{{ $xuzu[0]->gambar }}">
                    </div>
                    ...
                    <div class="card-footer px-3 pb-3 pt-0 d-flex">
                        <a href="{{ route('product_detail', ['product' => 'xuzu', 'id' => $xuzu[0]->id]) }}" class="btn btn-primary btn-primary__landing-page align-self-center me-2">Detail</a>
                        <a href="{{ 'https://wa.me/' . $wa_utama }}" class="btn btn-primary btn-succes__landing-page d-flex align-items-center">
            ...
            <div class="col-md-4">
                <div class="card h-100">
                    ...
                    <div class="thumbnail">
                        <img src="{{ asset('images/post/product/bintang_konveksi/' . $bintangKonveksi[0]->gambar_bk) }}" class="card-img-top" alt="{{ $bintangKonveksi[0]->gambar_bk }}">
                    </div>
                    <div class="card-body p-3">
                    ...
                    <div class="card-footer px-3 pb-3 pt-0 d-flex">
                        <a href="{{ route('product_detail', ['product' => 'bintang-konveksi', 'id' => $bintangKonveksi[0]->id]) }}" class="btn btn-primary btn-primary__landing-page me-2">Detail</a>
                        <a href="{{ 'https://wa.me/' . $wa_utama }}" class="btn btn-primary btn-succes__landing-page d-flex align-items-center">
                            <i class="ti ti-brand-whatsapp fs-6 me-1"></i>
                            <span>Pesan</span>
                        </a>
            ...
            <div class="col-md-4">
                <div class="card h-100">
                    ...
                    <div class="thumbnail">
                        <img src="{{ asset('images/post/product/aneka_slempang/' . $anekaSlempang[0]->gambar_as) }}" class="card-img-top" alt="{{ $anekaSlempang[0]->gambar_as }}">
                    </div>
                    <div class="card-body p-3">
                    ...
                    <div class="card-footer px-3 pb-3 pt-0 d-flex">
                        <a href="{{ route('product_detail', ['product' => 'aneka-slempang', 'id' => $anekaSlempang[0]->id]) }}" class="btn btn-primary btn-primary__landing-page me-2">Detail</a>
                        <a href="{{ 'https://wa.me/' . $wa_utama }}" class="btn btn-primary btn-succes__landing-page d-flex align-items-center">
                            <i class="ti ti-brand-whatsapp fs-6 me-1"></i>
                            <span>Pesan</span>
                        </a>
