        ...
        <div class="row gy-4">
            <div class="col-md-4">
                <div class="card h-100">
                    ...
                    <div class="card-footer px-3 pb-3 pt-0 d-flex">
                        <a href="#" class="btn btn-primary btn-primary__landing-page align-self-center me-2">Detail</a>
                        <a href="{{ 'https://wa.me/'. $sosmed[0]->whatsapp }}" class="btn btn-primary btn-succes__landing-page d-flex align-items-center">
            ...
            <div class="col-md-4">
                <div class="card h-100">
                    ...
                    <div class="card-footer px-3 pb-3 pt-0 d-flex">
                        <a href="#" class="btn btn-primary btn-primary__landing-page me-2">Detail</a>
                        <a href="{{ 'https://wa.me/'. $sosmed[0]->whatsapp }}" class="btn btn-primary btn-succes__landing-page d-flex align-items-center">
                            <i class="ti ti-brand-whatsapp fs-6 me-1"></i>
                            <span>Pesan</span>
                        </a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <p class="mb-0 text-break fw-bold text-dark">Bekerja sama dengan seluruh ekspedisi di indonesia. Pengiriman paket melalui mitra ekspedisi terpecaya. Pastikan paketnya sampai dengan aman dan selamat smapai tujuan.</p>
            </div>
            <div class="col-md-6">
