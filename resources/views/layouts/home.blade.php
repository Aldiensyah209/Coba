                ...
                <div class="col-md-4 align-self-center mb-sm center-sm">
                    @if (count($home))
                        {{-- <div class="position-relative title">
                            <h1 class="position-absolute mb-0"><strong>{{ $home->first()->judul }}</strong></h1>
                            <div class="bg-title position-absolute overflow-hidden">
                                <img src="{{ asset('images/backgrounds/bg-title.png') }}" alt="">
                            </div>
                        </div> --}}
                        <h1 class="title"><strong>{{ $home->first()->judul }}</strong></h1>
                        <h2 class="my-4">{!! $home->first()->deskripsi !!}</h2>
                ...
                <div class="row gy-4">
                    <div class="col-md-4">
                        <div class="card h-100">
                            ...
                            <div class="card-footer px-3 pb-3 pt-0 d-flex">
                                <a href="{{ route('product_detail', ['product' => 'xuzu', 'id' => $xuzu[0]->id]) }}"
                                    class="btn btn-primary btn-primary__landing-page align-self-center me-2">Detail</a>
                                <a href="{{ 'https://wa.me/' . $wa_utama }}"
                    ...
                    <div class="col-md-4">
                        <div class="card h-100">
                            ...
                            <div class="card-footer px-3 pb-3 pt-0 d-flex">
                                <a href="{{ route('product_detail', ['product' => 'bintang-konveksi', 'id' => $bintangKonveksi[0]->id]) }}"
                    ...
                    <div class="col-md-4">
                        <div class="card h-100">
                            ...
                            <div class="card-footer px-3 pb-3 pt-0 d-flex">
                                <a href="{{ route('product_detail', ['product' => 'aneka-slempang', 'id' => $anekaSlempang[0]->id]) }}"
                                    class="btn btn-primary btn-primary__landing-page me-2">Detail</a>
                                <a href="{{ 'https://wa.me/' . $wa_utama }}"
                                    class="btn btn-primary btn-succes__landing-page d-flex align-items-center">
                                    <i class="ti ti-brand-whatsapp fs-6 me-1"></i>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-wrap">
                        <a href="https://jne.co.id/shipping-fee"
                            class="logo-container overflow-hidden rounded bg-light p-3 me-3 mt-5 mt-md-5 mt-lg-0 flex-fill"
                            target="_blank" rel="noopener">
                            <img src="{{ asset('images/logos/JNE.svg') }}" alt="Logo JNE">
                        </a>
                        <a href="https://www.jet.co.id/rates"
                            class="logo-container overflow-hidden rounded bg-light p-3 me-3 mt-3 mt-md-3 mt-lg-0 flex-fill"
                            target="_blank" rel="noopener">
                            <img src="{{ asset('images/logos/j-t-express.svg') }}" alt="Logo J&T Express">
                        </a>
                        <a href="https://lionparcel.com/tarif"
                            class="logo-container overflow-hidden rounded bg-light p-3 me-3 mt-3 flex-fill"
                            target="_blank" rel="noopener">
                            <img class="rounded" src="{{ asset('images/logos/lion-parcel.png') }}"
                                alt="Logo Lion Parcel">
                        </a>
                        <a href="https://indahonline.com/shipping/rates"
                            class="logo-container overflow-hidden rounded bg-light p-3 me-3 mt-3 flex-fill"
                            target="_blank" rel="noopener">
                            <img class="rounded" src="{{ asset('images/logos/indah-logistik-cargo.svg') }}"
                                alt="Logo Indah Logistik">
                        </a>
                        <a href="https://www.jtcargo.id/networkQuery?type=2&senderAddressVal=&receiveAddressVal=&sender=%7B%22areaId%22%3A%22%22,%22cityId%22%3A%22%22,%22provinceId%22%3A%22%22%7D&receive=%7B%22areaId%22%3A%22%22,%22cityId%22%3A%22%22,%22provinceId%22%3A%22%22%7D&weight"
                            class="logo-container overflow-hidden rounded bg-light p-3 me-3 mt-3 flex-fill"
                            target="_blank" rel="noopener">
                            <img class="rounded" src="{{ asset('images/logos/jt-cargo.svg') }}" alt="Logo J&T Cargo">
                        </a>
                        <a href="https://www.sicepat.com/deliveryFee"
                            class="logo-container overflow-hidden rounded bg-light p-3 me-3 mt-3" target="_blank"
                            rel="noopener">
                            <img src="{{ asset('images/logos/sicepat-ekspres.svg') }}" alt="Logo Si Cepat Express">
                        </a>
                        <a href="https://www.posindonesia.co.id/id/check-tarif"
                            class="logo-container overflow-hidden rounded bg-light p-3 me-3 mt-3" target="_blank"
                            rel="noopener">
                            <img src="{{ asset('images/logos/pos-indonesia.svg') }}" alt="Logo Pos Indonesia">
                        </a>
                        <a href="https://www.ninjaxpress.co/id-id#price-estimate"
                            class="logo-container d-block overflow-hidden rounded bg-light p-3 me-3 mt-3" target="_blank"
                            rel="noopener">
