...
<div id="product-list">
    <div class="container">
        <h5 class="text-center text-headline mt-4">BINTANG KONVEKSI</h5>
        ...
        <div class="row mb-5 g-4">
            ...
            <div class="col-md-4 col-lg-3">
                <div class="card h-100">
                    <div class="thumbnail">
                        <img src="{{ asset('images/post/product/bintang_konveksi/' . $item->gambar_bk) }}" class="card-img-top" alt="{{ $item->gambar_bk }}">
                    </div>
