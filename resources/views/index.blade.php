            ...
            <div class="container pt-5 pb-4">
                <div class="row mb-5 gy-4">
                    <div class="col-md-6">
                        ...
                        <p class="text-break fw-bold text-dark mb-0">Brand fashion berkualitas premium indonesia.</p>
                    </div>
                    <div class="col-md-6">
                        <div class="row gy-4">
                            <div class="col-md-6">
                                <h4 class="mb-2 mb-md-3">Product</h4>
                                <ul class="fw-bold mb-0">
                            ...
                            <div class="col-md-6">
                                ...
                                <ul class="fw-bold mb-0">
                                    ...
                                    <li><a class="d-block fw-bold" href="{{ 'https://wa.me/' . $item }}" target="_blank" rel="noopener">{{ $item }}</a></li>
                                    @endforeach
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="text-sosmed">
                                        ...
                                        <a class="d-block fw-bold" href="{{ 'https://www.instagram.com/' . $item }}" target="_blank" rel="noopener">{{ '@' . $item }}</a>
                                        @endforeach
                                    </div>
                                </div>
                                <div class="d-flex align-items-center mt-2">
                                    ...
                                    <div class="text-sosmed">
                                        ...
                                        <a class="d-block fw-bold" href="{{ 'https://www.facebook.com/' . $item }}" target="_blank" rel="noopener">{{ '@' . $item }}</a>
                                        @endforeach
                                    </div>
                                </div>
                                <div class="d-flex align-items-center mt-2">
                                    ...
                                    <div class="text-sosmed">
                                        ...
                                        <a class="d-block fw-bold" href="{{ 'https://www.tiktok.com/@' . $item }}" target="_blank" rel="noopener">{{ '@' . $item }}</a>
                                        @endforeach
                                    </div>
                                </div>
                            </div>
