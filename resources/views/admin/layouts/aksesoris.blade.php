...
<div class="card w-100">
  <div class="card-body p-4">
    <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
      <h5 class="card-title fw-semibold mb-0">Daftar Aksesoris</h5>
      <a href="#" class="btn btn-primary fw-semibold"><i class="ti ti-plus fw-semibold me-2"></i>Tambah Aksesoris</a>
    </div>
