...
<div class="card w-100">
  <div class="card-body p-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-9">
      ...
      <a href="#" class="btn btn-primary fw-semibold" data-bs-toggle="modal" data-bs-target="#tambahKontenAboutModal"><i class="ti ti-plus fw-semibold me-2"></i>Tambah</a>
    </div>
    <!-- Data Table -->
...
<!-- Create Modal -->
<div class="modal fade" id="tambahKontenAboutModal" tabindex="-1" aria-labelledby="tambahKontenAboutModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="tambahKontenAboutModalLabel">Tambah Konten</h5>
...
<!-- Edit Modal Konten -->
@if(count($konten))
<div class="modal fade" id="editKontenAboutModal" tabindex="-1" aria-labelledby="editKontenAboutModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editKontenAboutModalLabel">Edit Konten</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
