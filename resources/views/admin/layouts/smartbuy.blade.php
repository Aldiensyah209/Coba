...
@section('kontent')
    ...
    <div class="card w-100">
        <div class="card-body p-4">
            ...
            <div class="d-flex align-items-center justify-content-between mb-9">
                <h5 class="card-title fw-semibold mb-0">Konten Tips</h5>

                <a href="#" class="btn btn-primary fw-semibold" data-bs-toggle="modal"
                    data-bs-target="#tambahKontenModalSmartbuy"><i class="ti ti-plus fw-semibold me-2"></i>Tambah List</a>
                        ...
                        @if (count($kontentsmartbuy))
                            @foreach ($kontentsmartbuy as $item)
                                <tr>
                                    ...
                                    <td class="border-bottom-0">
                                        @if ($item->gambar)
                                            <img src="{{ asset('images/post/landingPage/' . $item->gambar) }}"
                                    ...
                                    <td class="border-bottom-0">
                                        <p class="mb-0 fw-normal text-wrap" style="width: 14rem;">
                                            {{ Str::limit($item->deskripsi, 45) }}</p>
                                    </td>
                                    <td class="border-bottom-0">
                                        <button type="button" class="btn btn-warning m-1" id="buttonEdit"
                                            data-id="{{ $item->id }}" data-bs-toggle="modal"
                                            data-bs-target="#editKontenModalSmartbuy">
    ...
    <!-- Create Modal Konten -->
    <div class="modal fade" id="tambahKontenModalSmartbuy" tabindex="-1" aria-labelledby="tambahKontenModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="createForm" action="{{ route('smartbuyAdmin.store') }}" method="POST"
    ...
    <!-- Edit Modal Konten -->
    @if (count($kontentsmartbuy))
        <div class="modal fade" id="editKontenModalSmartbuy" tabindex="-1" aria-labelledby="editKontenModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
