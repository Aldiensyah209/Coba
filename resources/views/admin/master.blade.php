      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link {{ Request::is('*baju*') ? 'active' : '' }}" href="{{ route('baju') }}" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link {{ Request::is('*celana*') ? 'active' : '' }}" href="{{ route('celana') }}" aria-expanded="false">
                <span>
                  <i class="ti ti-shirt"></i>
                </span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link {{ Request::is('*aksesoris*') ? 'active' : '' }}" href="{{ route('aksesoris') }}" aria-expanded="false">
                <span>
